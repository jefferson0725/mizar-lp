    ...
    <section className="py-20 px-6 bg-white">
      <div className="max-w-2xl mx-auto">
        ...
        <a
          ...
          className="flex items-center justify-center gap-3 w-full bg-[#25D366] text-white font-bold py-5 rounded-xl text-lg hover:bg-[#128C7E] transition-colors duration-300 mb-8"
        >
          <WhatsAppIcon />
