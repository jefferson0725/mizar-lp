      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <ul className="space-y-3 sm:space-y-4">
            {items.map((row, i) => (
              <li key={i} className="flex items-center gap-2 sm:gap-3">
                <Check
                  className="w-5 h-5 text-rojo-light flex-shrink-0"
                  aria-hidden="true"
                />
                <span className="text-blanco text-xs sm:text-base font-medium flex-1 sm:flex-none">
                  {row.label}
                </span>
                <span
                  className="hidden sm:block flex-1 border-b border-dotted border-white/25 mx-1 translate-y-1"
                  aria-hidden="true"
                />
                <span className="text-rojo-light text-xs sm:text-base font-semibold">
                  {row.valor}
                </span>
              </li>
            ))}
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full bg-[#25D366] text-white font-bold py-4 px-4 rounded-xl text-lg hover:bg-[#128C7E] transition-colors duration-300 text-center"
          >
            <WhatsAppIcon />
