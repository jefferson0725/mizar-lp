...
const CONFIG: Record<string, WhatsAppConfig> = {
  '/': {
    ...
    message: 'Hola, vengo de la web de Grupo Mizar y quiero información sobre sus proyectos.',
  },
  '/nosotros': {
    phone: PHONES.general,
    message: 'Hola, vi la página de Grupo Mizar y quiero conocer más sobre la empresa y sus proyectos.',
  },
  '/proyectos': {
    phone: PHONES.general,
    message: 'Hola, vi el portafolio de Grupo Mizar y quiero información sobre los proyectos disponibles.',
  },
  '/contacto': {
    phone: PHONES.general,
    message: 'Hola, vengo de la web de Grupo Mizar y quiero ponerme en contacto.',
  },
  '/blog': {
    phone: PHONES.general,
    message: 'Hola, leí el blog de Grupo Mizar y tengo una consulta sobre propiedades.',
  },
  '/lotes-cucuta': {
    phone: PHONES.general,
    message: 'Hola, me interesan los lotes urbanos de Mi Lote en Cúcuta, mi nombre es',
  },
  '/laureles-campestre': {
    phone: PHONES.laureles,
    message: 'Hola, me interesan los apartamentos de Laureles Campestre en Girón, mi nombre es',
  },
  '/terrazas': {
    phone: PHONES.terrazas,
    message: 'Hola, me interesan los apartamentos de Terrazas de la Cantera en Piedecuesta, mi nombre es',
  },
  '/parcelas-campestres-santander': {
    phone: PHONES.general,
    message: 'Hola, me interesan las parcelas campestres en Santander, mi nombre es',
  },
  '/inversion-inmobiliaria-colombia-exterior': {
    phone: PHONES.general,
    message: 'Hola, vivo en el exterior y quiero invertir en Colombia con Grupo Mizar, mi nombre es',
  },
};
